...
function Overview(props) {
  ...
  let actionClassname = "actionControls  needAction";
  ...
  const getActions = async (e) => {
    ...
    if (JSON.stringify(accountDetails) !== JSON.stringify(userBankDetails)) {
      ...
      actionClassname = "actionControls";
    }
  };
  getActions();
  return (
    <div className="mainDashboard">
      ...
      {menu && (
        <div className="menuContainer" onClick={(e) => setMenu(false)}>
          <div className="menu">
                  ...
                  <div className="menuOptionsContainer">
                    <div className="menuOptions">
                      <img
                        ...
                        alt="Message"
                      ></img>
                      <Link className="menulinks" to="/overview">
                        <p>Overview</p>
                      </Link>
                    </div>
                  </div>
        ...
        <div className="dashboardContent">
          <div className="businessOverview">
            ...
            <p className="overViewHeading">
              {currentUser.fname}'s Business Overview
            </p>
      ...
      /> */}
              <Calendar
                ...
                tileClassName={({ date, view }) => {
                  if (
                    scheduledDates.find((x) => x === date.toLocaleDateString())
                  ) {
                    console.log("Yessserstyyxd");
                    return "highlight";
                  }
                }}
                className="calendarFull"
                value={date}
                minDate={new Date()}
              ></Calendar>
            </div>
