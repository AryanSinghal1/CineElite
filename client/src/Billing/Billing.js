...
<div className='h-6 w-6 rounded-full bg-yellow-300 flex justify-center items-center'>
  <p className='font-bold text-xl'>1</p>
    ...
    <div className='flex flex-col justify-center items-start rounded-xl w-[80%] h-[23%] bg-white'>
        ...
        <div className=' w-1/2 h-full flex justify-center items-center'>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="green" className="w-3 h-3">
  <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75L12 3m0 0l3.75 3.75M12 3v18" />
        ...
        <div className=' w-1/2 h-full flex justify-center items-center'>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="red" className="w-3 h-3">
  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 13.5L12 21m0 0l-7.5-7.5M12 21V3" />
      ...
      <div className='h-1/4 w-full'>
        ...
        <div className='h-2/3 w-1/2 flex flex-col justify-start items-center'>
          ...
          <div className='h-full w-2/3 flex justify-between items-center'>
            ...
            <div datepicker="true" id="dateChose" className='w-[48%] h-2/3 bg-white rounded-lg flex justify-between items-center relative'>
              <div className="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
        <svg aria-hidden="true" className="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd"></path></svg>
    </div>
    <input datepicker="true" name="start" type="text" className="sm:text-sm rounded-lg focus:ring-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark: dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="From" onFocus={e=>e.target.type="date"}/>
    ...
    <input datepicker="true" name="start" type="text" className="cursor-pointer sm:text-sm rounded-lg focus:ring-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark: dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="To" onFocus={e=>e.target.type="date"}/>
            </div>
            </div>
            </div>
</div>
...
<div className='h-[90%] w-[90%] flex flex-col justify-center items-center'>
    ...
    <div className='h-[90%] w-full '>
      <Doughnut data={pieChartData} style={{ height:"85%", width:"80%"}}
