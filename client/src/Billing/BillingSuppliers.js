...
function BillingSuppliers() {
  ...
  return (
    ...
    <div className='flex-col h-[200vh] w-screen'>
            <div className='h-screen w-full bg-black bg-opacity-20 absolute z-10 flex justify-center items-center'>
      ...
      <div className='h-[10%] w-full flex items-center justify-between'>
        <p className='font-bold text-2xl'>Add Supplier</p>
        ...
        <form className='w-full h-full flex flex-col' onChange={handleValues} onSubmit={handleSubmit}>
          <div className='h-5/6 w-full flex flex-wrap justify-between items-center'>
            <div className='h-[30%] w-[45%] flex flex-col justify-around items-start'>
              ...
              <input type="text" name='suppName' className='border border-slate-400 py-0.5 w-full rounded-lg'></input>
            </div>
            <div className='h-[30%] w-[45%] flex flex-col justify-around items-start'>
              <label>Company</label>
    ...
    <div className='flex flex-col h-[95%] w-[95%] '>
        <div className='w-full h-1/6 flex flex-col items-center justify-center'>
            <div className='h-1/3 w-full'>
                <h3 className='font-bold text-3xl'>Suppliers</h3>
            </div>
...
<form class="flex items-center h-full w-3/5">   
    <label for="simple-search" class="sr-only">Search</label>
    <div class="relative w-full h-full">
        <div class="flex absolute h-full inset-y-0 left-0 items-center pl-3 justify-center pointer-events-none">
            <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path></svg>
        </div>
        <input type="text" id="simple-search" class="h-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500  rounded-2xl focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" required=""/>
    </div>
</form>
            </div>
            <div className='h-full w-[26%] flex justify-between items-center'>
            <button className="bg-transparent hover:bg-cineBlue text-cineBlue hover:text-white py-2 px-4 border border-cineBlue hover:border-transparent rounded-2xl">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 inline-flex">
      ...
      <div class="overflow-hidden">
        <table class="min-w-full">
          <thead class="bg-white border-b">
            <tr>
              <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left text-slate-400">
                Supplier Name
              </th>
              <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left text-slate-400">
                Company
...
export default BillingSuppliers